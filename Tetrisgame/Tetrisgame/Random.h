...
public:
    ...
    // </summary>
    // <param name="maxExclude">최댓값-1</param>
    // <returns>랜덤한 정수</returns>
    int GetRandom(int maxExclude)
    {
        // 균등분포로 처리
        std::uniform_int_distribution<int> dis(0, maxExclude - 1);  // 파라미터로 입력받은 개수만큼 처리하기 위해
    ...
    // 지정된 범위의 정수를 리턴하는 함수
    // </summary>
    // <param name="minInclude">최솟값</param>
    // <param name="maxInclude">최댓값</param>
